...
void RenderingSystem::Update(entt::registry* reg)
{
	...
	auto view2_1 = reg->view<Horizontal_Scroll>();
	...
	auto view2_2 = reg->view<Vertical_Scroll>();
	...
	//loop runs through all the entities within view3

	for (auto entity : view3) {

		auto &bar = view3.get(entity);
//displays current health with the entity number
	//	cout << "Entity number " << to_string(entity) << ":";
		bar.displayhealth();
	}

	//creates a view consisting of all entites containing horizontal scroll
