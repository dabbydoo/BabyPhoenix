...
unsigned int EntityIdentifier::m_veriscrollcamerabit= 0x2;
...
unsigned int EntityIdentifier::horizontalscrollcameraBit()
{
	return m_horiscrollcamerabit;
}

unsigned int EntityIdentifier::verticalscrollcameraBit()
{
	return m_veriscrollcamerabit;
}
